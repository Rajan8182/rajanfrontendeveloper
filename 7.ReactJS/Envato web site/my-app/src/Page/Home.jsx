  ...
  return (
    <div className="container mx-auto px-6 lg:px-16 py-10">
      <div className="flex flex-wrap lg:flex-nowrap gap-10 justify-center">
        <div className="bg-white dark:bg-gray-800 text-black dark:text-white shadow-lg p-6 w-full sm:w-[400px] rounded-2xl flex flex-col items-center">
        ...
        <div className="bg-white dark:bg-gray-800 text-black dark:text-white shadow-lg p-6 w-full sm:w-[400px] rounded-2xl">
          ...
          <div className="m-4 mt-28 flex justify-center">
            <img src={img7} alt="Project 2" className="rounded-lg shadow-md" />
          </div>
        </div>
      </div>

      <div className="flex flex-wrap  lg:flex-nowrap gap-10 justify-center mt-10">
        <div className="bg-white dark:bg-gray-800 text-black dark:text-white shadow-md p-6 rounded-2xl w-full lg:w-[860px]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            {["UI UX Design", "Mobile App", "Product Design", "Branding"].map((service, idx) => (
              <div key={idx} className="border bg-slate-300 dark:bg-gray-800 text-black dark:text-white p-4 rounded-lg text-center">
                <img
                  src={require("../Pic/ui-ux.svg").default}
                  alt={service}
                  className="w-32 h-20 bg-white shadow-md rounded-lg mx-auto"
                />
                <h3 className="mt-4 dark:text-white text-gray-800">{service}</h3>
              </div>
            ))}
          </div>
        </div>
