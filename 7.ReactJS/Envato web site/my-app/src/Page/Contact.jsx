          ...
          <div className="bg-white dark:bg-gray-800 text-black dark:text-white p-6 rounded-lg shadow-md mt-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block dark:text-white text-gray-700">Name</label>
                  <input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="block dark:text-white text-gray-700">Email</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block dark:text-white text-gray-700">Subject</label>
                  <input
                    type="text"
                    name="subject"
                ...
                <div>
                  <label className="block dark:text-white text-gray-700">Budget</label>
                  <select
                    name="budget"
              ...
              <div>
                <label className="block dark:text-white text-gray-700">Comment</label>
                <textarea
                  name="comment"
