      ...
      <div className="flex  gap-3">
        ...
        <div className="w-[870px] p-6 bg-white dark:bg-gray-800 text-black dark:text-white shadow-lg rounded-2xl">
          ...
          <div className="flex  flex-col gap-4">
            ...
            <Faqs />
            <marquee className="flex justify-between border rounded-xl dark:bg-gray-800 text-black dark:text-white bg-gray-100 p-4 font-bold text-4xl hover:bg-white" direction="left">
              <div>
