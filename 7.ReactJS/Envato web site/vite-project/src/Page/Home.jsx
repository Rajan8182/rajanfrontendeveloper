...
// Importing images correctly in Vite
import img1 from "../Pic/1.png";
import img6 from "../Pic/project-1.png";
import img7 from "../Pic/project-2.png";
import uiuxImg from "../Pic/ui-ux.svg";

const Home = () => {
  return (
    <div className="container mx-auto py-10">
      <div className="flex gap-3 justify-center">
        <div className="bg-white text-black shadow-lg p-6 w-full sm:w-[400px] h-[690px] rounded-2xl flex flex-col items-center">
          ...
          <div className="flex gap-4 mt-8 justify-center">
            <button className="bg-blue-600 text-white p-2 rounded-lg">📞 Book a Call</button>
            <button className="border p-2 rounded-lg">📩 Copy Email</button>
          </div>
          <div className="flex items-center mt-8 gap-4">
            {[FaFacebook, FaPinterest, FaGithub, FaYoutube].map((Icon, idx) => (
              <div key={idx} className="border border-gray-300 rounded-lg p-3 flex items-center justify-center transition duration-300">
        ...
        <div className="bg-white text-black shadow-lg p-6 w-full sm:w-[400px] h-[690px] rounded-2xl">
      ...
      <div className="flex flex-wrap lg:flex-nowrap gap-3 justify-center mt-3">
        <div className="bg-white text-black shadow-md p-6 rounded-2xl w-full lg:w-[860px]">
          <div className="flex justify-between">
            <h2 className="text-xl font-bold">Services I Offer</h2>
            <button className="text-blue-700">See All Services</button>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            {["UI UX Design", "Mobile App", "Product Design", "Branding"].map((service, idx) => (
              <div key={idx} className=" bg-slate-300 text-black p-4 rounded-lg text-center">
                <img src={uiuxImg} alt={service} className="w-32 h-20 bg-white shadow-md rounded-lg mx-auto" />
                <h3 className="mt-4 text-gray-800">{service}</h3>
              </div>
            ))}
          </div>
        </div>

        <div className="bg-white text-black shadow-md p-6 rounded-2xl w-full sm:w-[400px]">
          <marquee className="border bg-white text-black p-3 hover:bg-white rounded-lg">
