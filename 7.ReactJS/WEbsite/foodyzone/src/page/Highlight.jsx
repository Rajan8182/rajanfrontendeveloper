...
//   return (
//     <div className="slider-container bg-green-50  h-[600px] w-[9px00] m-28 rounded-2xl">
//       <div>
//         <Slider {...settings}>
//           <div className=" w-full m-14 py-10 lg:px-20">
...
//                 <h2 className="text-4xl font-bold text-blod mb-4">
...
//           </div>
//           {/* 2 */}
//           <div className="slider-container bg-green-50  h-[600px] w-[9px00] rounded-2xl">
//             <div className="bg-green-50 py-10 px-4 lg:px-20">
//               <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
//                 {/* Text Section */}
//                 <div className="flex flex-col justify-center">
...
//                       src={img_18}
//                       alt="Salad Bowl"
//                       className="rounded-lg m- w-full h-full object-cover"
//                     />
//                   </div>
//                   <div className="relative">
//                     <img
